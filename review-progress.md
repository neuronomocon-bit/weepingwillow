...
| Ch22 | **1 structural + 1 continuity + 1 confidence** | **⚠️ THE CODA HAD MOVED THE BOOK'S FINAL IMAGE OFF IRIS AND ONTO THE ENTITY.** It closed on *“She went down the stairs and out onto the street…”* — a strong line that ends the book on **the thing carrying its new information toward Book 3 rather than on the woman left permanently unfinished**, so *“the plant becomes the destination rather than the residue of Iris's failed completion.”* **The coda had also grown from a paragraph-shaped afterimage into a seven-paragraph scene ending in physical action, despite staying under the word ceiling.** Rebuilt to five paragraphs, 273 words, no action, closing on the open value's address: *“a room with the lamp turned off and a woman in it who has been gone over twice and has nothing further in her to remove.”* Plus *five months* of self-measurement against the chapter's own *four months* (**the NUMBERS corollary: one figure per rendering**), and *“the only person alive who could describe this”* narrowed to ***“no account of this anywhere in her record”*** — **she cannot know every person the entity has ever contacted, in a book built on the missing denominator.** ⚠️ **A nearby phrase was checked and kept:** *“nearer to it than any living person”* pays published Book 1 Ch22's locked *“Than anyone else alive.”* |
...
**The coda closed on the entity walking into the street.** Under the word ceiling, but seven paragraphs and ending in physical action, so it had become a short scene rather than the process afterimage the brief specifies — **and it moved the book's final image off Iris.** The author: *“The book should close on the woman left in the room, not on the thing walking toward the sequel. This is a structural requirement, not a line-level preference.”* **Rebuilt to five paragraphs and 273 words, ending on the open value's address.**

**The author ruled the length correct** — the chapter *“earns its 85%”* — **and ruled the book being over target immaterial: do not cut for the total.** All five pieces of record work were ruled correct and kept, the amendment card singled out as *“Iris's permanent condition rendered without the narration naming it.”*
